...
_G.packer_plugins = {
  ...
  ScrollColors = {
    loaded = true,
    path = "/home/jordan/.local/share/nvim/site/pack/packer/start/ScrollColors",
    url = "https://github.com/vim-scripts/ScrollColors"
  },
  catppuccin = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20setup/catpuccin\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20setup/catpuccin\frequire\0", "config", "catppuccin")
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-numbertoggle'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
