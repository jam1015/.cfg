...
_G.packer_plugins = {
  ...
  ["vim-rooter"] = {
    config = { "\27LJ\2\nÇ\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0clet g:rooter_manual_only = 1\n nnoremap <leader>fr:  :edit <c-r>=FindRootDirectory()<CR>/**/*\n \bcmd\bvim\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\nΩ\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0ù\1  let g:vimtex_view_method = 'zathura'\n  let g:vimtex_view_general_viewer = 'zathura'\n  let g:vimtex_view_enabled=1\n  let g:vimtex_complete_enabled=0\n \t\bcmd\bvim\0", "setup", "vimtex")
